...
<div class="add-post-section ">
    <ul class="nav nav-pills flex-wrap mb-3 px-3" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="btn-step1" data-bs-toggle="pill" data-bs-target="#pills-ads" type="button"
                role="tab" aria-controls="pills-ads" aria-selected="true">Post your Ad</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="btn-step2" data-bs-toggle="pill" data-bs-target="#pills-type" type="button"
                role="tab" aria-controls="pills-type" aria-selected="false">Post Type</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="btn-step3" data-bs-toggle="pill" data-bs-target="#pills-category"
                type="button" role="tab" aria-controls="pills-category" aria-selected="false">Category</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="btn-step4" data-bs-toggle="pill" data-bs-target="#pills-media" type="button"
                role="tab" aria-controls="pills-media" aria-selected="false">Media</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="btn-step5" data-bs-toggle="pill" data-bs-target="#pills-description"
    ...
    <div class="post-ad-details mb-5">
        <form
            action="@if (isset($product)) {{ route('user.product.update', $product->id) }}@else{{ route('user.product.store') }} @endif"
            id="product" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-lg-9 " id="step1">
                    <div class="l-ad-content">
                        ...
                        <div class="add-types border-top d-flex flex-wrap justify-content-center align-items-center ">
                            ...
                            <select id="type_of" name="type_of" class="form-control w-75 fs-4"
                    ...
                    <div class="l-ad-content">
                        ...
                        <div class="type-checklist border-top mx-auto">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="type_of_post" id="sell"
                                    value="sell" checked>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="type_of_post" id="gift"
                                    value="gift">
                        ...
                        <div class="ad-n-btn d-flex justify-content-center align-items-center">
                            ...
                            <a href="javascript:;" onclick="next_step2()"
                                class=" next_btn nextbtn_ text-white">Next</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="l-ad-content">
                                        ...
                                        <ul class="items child" id="{{ $category->id }}" style="display: none;"
                                            ...
                                            @foreach ($childs as $child)
                                                <li class="ms-4"><input type="radio" id="{{ $child->id }}"
                                                        value="{{ $child->id }}" name="category_id" class="me-3"
                                                        @if (isset($product->category_id)) @if ($child->id == $product->category_id) checked @endif
                                                        @endif><label
                                                        for="{{ $child->id }}">{{ $child->name }}</label></li>
                                            @endforeach
                                        </ul>
                                    @else
                                        <span class="one-anchor w-100"><input type="radio"
                                                id="{{ $category->id }}" value="{{ $category->id }}"
                                                name="category_id" class="me-3 item"
                                                @if (isset($product->category_id)) @if ($category->id == $product->category_id) checked @endif
                                                @endif><label
                        ...
                        <div class="ad-n-btn d-flex flex-wrap justify-content-center align-items-center">
                            <a href="javascript:;" onclick="pre_step3()"
                                class="previous_btn me-4 nextbtn_ ">Previous</a>
                            <a href="javascript:;" onclick="next_step3()"
                                class="next_btn nextbtn_ text-white">Next</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="l-ad-content">
                        ...
                        <div class="upload-file_input border-top">
                            <div id="dropBox">
                                ...
                                <form class="imgUploader">
                                    @if(isset($product->pictures))
                                        ...
                                        <input type="hidden" id="oldImg" value="{{$img->filename}}" name="image[]">
                                        @endforeach
                                    @endif
                            ...
                            <div class="v-input d-flex flex-wrap justify-content-center align-items-center">
                                ...
                                <div class="w-50">
                                    <input type="text" id="inputtext6" class="form-control" name="video"
                                        id="video" aria-describedby="textHelpInline">
                                </div>
                            </div>
                        ...
                        <div class="ad-n-btn p-0 d-flex flex-wrap justify-content-center align-items-center">
                            <a href="javascript:;" onclick="pre_step4()"
                                class="previous_btn me-4 nextbtn_ ">Previous</a>
                            <a href="javascript:;" onclick="next_step4()"
                                class="next_btn nextbtn_ text-white">Next</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="l-ad-content">
                        ...
                        <div class="descript-section border-top">
                            ...
                            <div class="d-flex align-items-center mt-4 mb-1">
                                <label class="me-1" for="specificSizeSelect">Condition*</label>
                                <select class="form-control ad-select" id="condition" name="condition"
                                    style="width: 45%;">
                                    ...
                                    <option value="second_hand"
                                        @if (isset($product->condition)) @if ('second_hand' == $product->condition) selected @endif
                                        @endif>Second Hand</option>
                                </select>
                                <label class="text-end p-2" for="specificSizeSelect">Curency*</label>
                                <select class="form-control" id="currency" name="currency" style="width: 45%;">
                            ...
                            <div class="price-div d-flex flex-wrap justify-content-between align-items-center ">
                                    ...
                                    <div class="">
                                        <div class="price_div_check-box">
                                            <input class="form-check-input" type="checkbox" name="negotiable" value="1"
                                                id="negotiable" @if(isset($product->negotiable)) @if($product->negotiable == '1') checked @endif @endif>
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    <label class="my-2 text-end p-2 w-auto" for="specificSizeSelect">Sale Price</label>
                            ...
                            <div class="d-flex align-items-center pt-3">
                                ...
                                value="@if(isset($product->location)){{ $product->location }}@endif" id="autocomplete">
                            ...
                            <div class="d-flex align-items-center ">
                                ...
                                <input type="text" name="tags" class="form-control" style="width: 92%;"
                        ...
                        <div class="ad-n-btn d-flex flex-wrap justify-content-center align-items-center p-0">
                            ...
                            <div class="next_btn" id="submit-div"
                                @if(isset($product)) @else style="background-color: #9a9ea1;" @endif>
                                <a href="javascript:;" id="submit" class="nextbtn_ text-white"
                                    onclick="next_step5()"  @if(isset($product)) @else style="pointer-events: none;" @endif>Submit</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function next_step4() {
        ...
        if (submit == true) {
            ...
            $('#btn-step4').removeClass('active');
            $('#btn-step5').addClass('active');
        }
    }
...
<script>
    ...
    var result = $('#tag-input1').val()
    if(result =! null || result != undefined || result != '')
    {
        result = result.split(',');
        tagInput1.addData(result)
    }
</script>

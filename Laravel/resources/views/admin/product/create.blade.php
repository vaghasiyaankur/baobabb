...
<div class="card card-h-100">
   ...
   <div class="card-body">
      <div>
         <form action="@if(isset($product)){{ route('admin.product.update',[$product->id]) }}@else{{ route('admin.product.store') }}@endif" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-6">
               <div class="mb-3">
                  <label for="formFile" class="form-label custom-file-label font-size-17">impression</label>
                  <input class="form-control custom-file-input" name="impression" value="@if(isset($product->impression)){{$product->impression}}@endif" type="number" id="impression">
               </div>
            </div>

            <div class="col-md-6">
               <div class="mb-3">
                  <label for="formFile" class="form-label custom-file-label font-size-17">click</label>

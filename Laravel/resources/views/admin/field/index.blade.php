      ...
      <div class="col-lg-12">
         <div class="card">
            <div class="card-header justify-content-between d-flex align-items-right">
               <a href="{{route('admin.custom.field.create')}}" class="btn btn-success">Add New Custom Field <i class="mdi mdi-arrow-right align-middle"></i></a>
            </div>
            <!-- end card header -->
            <div class="card-body">
...
<script>
     $(function () {
        ...
        var table = $('#brand_list').DataTable({
            ...
            serverSide: true,
            pageLength : page,
            ajax: "{{ route('admin.custom.field.index') }}",
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
                {data: 'type', name: 'type'},

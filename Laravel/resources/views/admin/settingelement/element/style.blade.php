    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="hidden" name="body_background_image" value="" id="body-background-image-update">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="mb-3">
                ...
                <textarea class="form-control" name="custom_css" id="custom_css"  cols="100" rows="10" > @if (isset($elementdata)){{ @$elementdata->custom_css }}@endif</textarea>

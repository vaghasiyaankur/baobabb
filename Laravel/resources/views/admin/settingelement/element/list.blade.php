        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <select name="display_mode" style="width: 100%"
                    class="display_mode form-select select2_field select2-hidden-accessible" tabindex="-1"
                    aria-hidden="true">
                    <option value="0">Location not found page</option>
                    <option value="1" selected="">Show results with the country's most popular city</option>
                    <option value="2">Don't apply the location's filter</option>
                </select>

                    ...
                    <div class="row form_border">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input"
                                    value="@if($user->name){{ $user->name }}@endif" name="name"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input"
                                    value="@if($user->phone){{ $user->phone }}@endif" name="phone"
                   ...
                   <input class="form-control custom-file-input" value="" name="password" type="text" id="password" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input"
                                    value="@if($user->facebook){{ $user->facebook }}@endif" name="facebook"
                                    type="text" id="facebook" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input" name="twitter"
                                    value="@if ($user->twitter) {{ $user->twitter }} @endif" type="text"
                                    id="twitter" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input"
                                    value="@if($user->youtube){{ $user->youtube }}@endif" name="youtube"
                                    type="text" id="youtube" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input"
                                    value="@if($user->linkedin){{ $user->linkedin }}@endif" name="linkedin"
                                    type="text" id="linkedin" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input"
                                    value="@if($user->instagram){{ $user->instagram }}@endif"
                                    name="instagram" type="text" id="instagram" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input"
                                    value="@if ($user->website) {{ $user->website }} @endif" name="website"
                                    type="text" id="website" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input"
                                    value="@if ($user->description) {{ $user->description }} @endif"
                                ...
                                <select class="form-control custom-file-input" name="country" id="country">
                                    ...
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->id }}"
                                            @if (isset($user->country)) @if ($country->id == $user->country) selected @endif
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input"
                                    value="@if ($user->state) {{ $user->state }} @endif" name="state"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input"
                                    value="@if ($user->city) {{ $user->city }} @endif" name="city"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input"
                                    value="@if ($user->street) {{ $user->street }} @endif" name="street"
                                    type="text" id="street" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form_right_img text-center mb-4">
                                <img src="@if ($user->avatar) {{ asset($user->avatar) }}@else{{ asset('assets/images/brand_add_new1.jpg') }} @endif"
